...
Format-agnostic: whatever the source (xlsx, pdf, docx, video, text, Jira,
SharePoint), extraction normalises it into a flat list of `ContentBlock`s.
